...
- **Conversation:** retained cursor selection, larger independent preview/remove attachment controls, keyboard-contained image previews that close before the underlying Watch panel, retry for unavailable saved images, clipboard failure feedback, and consistent Stopping/error states in the composer, crew panel, and Watch.
